...
EXEC master.dbo.sp_addlinkedserver @server = N'MYPROD', @srvproduct=N'MYDBPRODUCT', @provider=N'MYDBPROVIDER', @datasrc=N'MYPROD', @provstr=N'DEFAULT COLLECTION=MY_PROD', @catalog=N'MYCATALOG'
