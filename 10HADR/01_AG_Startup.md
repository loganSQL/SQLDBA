...
REPLICA ON N'logansqltest01' WITH (ENDPOINT_URL = N'TCP://logansqltest01.logansql.net:5022', FAILOVER_MODE = MANUAL, AVAILABILITY_MODE = ASYNCHRONOUS_COMMIT, SEEDING_MODE = MANUAL, SECONDARY_ROLE(ALLOW_CONNECTIONS = NO)),
	N'logansqltest02' WITH (ENDPOINT_URL = N'TCP://logansqltest02.logansql.net:5022', FAILOVER_MODE = MANUAL, AVAILABILITY_MODE = ASYNCHRONOUS_COMMIT, SEEDING_MODE = MANUAL, SECONDARY_ROLE(ALLOW_CONNECTIONS = NO));
